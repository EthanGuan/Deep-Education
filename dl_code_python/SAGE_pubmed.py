...
if __name__ == "__main__":
    ...
    net = sageconv.GraphSageNet(G, input_feature_dim, 16, 3)
    ...
    # test_id = torch.tensor(train_id)
    # train_id = torch.tensor(test_id)
    # test_y_label = torch.tensor(train_y_label)
    # train_y_label = torch.tensor(test_y_label)
    ...
    all_logits = []
    #print(feature.shape, train_id.shape, test_id.shape)
